...
namespace Unity.Services.Authentication.Generated.Model
{
    ...
    internal partial class ErrorStatus
    {
        ...
        /// <param name="title">A short, human-readable summary of the problem type.  It SHOULD NOT change from occurrence to occurrence of the problem, except for purposes of localization. (required).</param>
